<template>
        <div>
            ...
            <button type="primary" round class="login">注册</button>
            <div class="register">
                <span @click="loginCode">登录 </span>
                <span @click="loginPassword">密码登录</span>
                <span>忘记密码</span>
            </div>
            <div class="other-login">
                <div>第三方登录</div>
                <div class="qq-weichat">
                    <img src="../../../public/img/zh/weichat.png" alt="">
                    <img src="../../../public/img/zh/QQ.png" alt="">
                </div>
            </div>
        </div>
    </template>
...
<script>
    export default {
        ...
        methods:{
            ...
            loginPassword(){
                this.$emit('changeLoginPasswordState')
            }
        }
    }
</script>
